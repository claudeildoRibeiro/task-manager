    ...
    <div class="container d-flex flex-column align-items-center justify-content-center" style="max-width: 400px;">
      <div class="card shadow-lg rounded-4 p-4 w-100"  data-aos-delay="100" style="background: rgba(30, 34, 45, 0.95); border: none;">
        ...
        <form method="POST" action="{{ route('login') }}">
          ...
          <button type="submit" class="btn btn-get-started w-100 py-2">Entrar</button>
        </form>
        <div class="mt-3 text-center">
          <a href="#" class="text-secondary">Esqueceu a senha?</a>
        </div>
        <div class="mt-3 text-center">
          <p class="text-secondary">Não tem uma conta? <a href="{{ route('register') }}" class="text-white">Registrar</a></p>
      </div>
    </div>
  </section>
